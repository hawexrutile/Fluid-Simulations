...
//params-begin
    ...
    int numParticles = 625;             // !Number of particles          100   625  300
    double boxSize = 100.0;              // !Size of the simulation box   12   250  175
    ...
    int dataCompression=5000;            // If dataCompression-n; The KE & PE at every nth timestep is writen in .dat file
    ...
    double theta = M_PI/4.0;            // Half of the opening angle of the vision cone (between pi/12 and pi/2)
...
int main() {
    ...
    for (int step = 0; step < numSteps; ++step) {
        ...
        if (fmod((100000.0 * step) / (numSteps * 1.0), 1.0) == 0.0) {
