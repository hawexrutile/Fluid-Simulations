...
//params-begin
    ...
    double packingFraction = 0.157;          //0.00785;
    ...
    int dataCompression = numSteps/10000;// If dataCompression-n; The KE & PE at every nth timestep is writen in .dat file
    //Vission parameters
    double theta = 90.0*(M_PI/180.0);   // *Half of the opening angle of the vision cone (between pi/12 and pi/2)
...
void initializeSystem(vector<Particle>& particles, double L, double p) {
    ...
    // Create a vector of particle IDs of length "numParticles" and fill it with 2's
