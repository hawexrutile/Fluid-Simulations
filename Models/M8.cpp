//removed std::
// Made noice as a sum of 2 components
//Fixed 15 deg dilutenes issue (replaced dt with sqrt(dt) in dphi calculation)
//Implemente cell list algorithm
//Added dual particle
//Added particle ID and mass to particle struc
//updated dirLocater to create a new directory if the current time is already taken
//initializeVelocityAndAcceleration is now Equilibriation and velocity list is now speedList 
